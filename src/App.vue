...
<template>
  <div class="app">
    <div class="header">
      ...
      <div class="menu">
        <div class="pointer" :class="active === 0 ? 'active' : ''" @click="menuChange(0)">首页</div>
        <div class="pointer" :class="active === 1 ? 'active' : ''" @click="menuChange(1)">文档</div>
        <div class="pointer" :class="active === 2 ? 'active' : ''" @click="menuChange(2)">组件</div>
      </div>
      <div class="other">
